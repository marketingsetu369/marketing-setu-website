  ...
  const services = [
    {
      ...
      badge: "MOST POPULAR",
      type: "main",
      title: "Smart Digital Business Cards & Profiles",
      description: "A modern, mobile-friendly digital profile page featuring your contact details, owner info, products gallery, location, and social links in one quick shareable link.",
      icon: SmartphoneNfcIcon,
      accentColor: "#7265E3",
      gradient: "from-[#6C5CE7] via-[#5B3DF5] to-[#4327D0]",
      bullets: [
        "1-Tap Save Contact & Instant WhatsApp Message",
        "Interactive Location Map & Business Directions",
        "Showcase Complete Product Gallery & Bio",
      ],
      actionLabel: "Get Digital Business Card",
      actionLink: "",
      isFeatured: true,
    },
    {
      ...
      bullets: [
        "Missed-Call Auto SMS & WhatsApp Greeting Bot",
        "Bulk Promotional & Festival Offer Broadcasts",
        "High Delivery Rates & Instant Customer Retention",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Single-Purpose Offer & Booking Pages",
        "Direct WhatsApp Ordering & Enquiry Integration",
        "Optimized for Instagram & Facebook Ad Campaigns",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Google Map Listing Verification & Setup",
        "Local Search Keyword Ranking (Pune, Satara, MH)",
        "5-Star Customer Review Generation Strategy",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Daily Cash Sales & Receipt Ledger Sheets",
        "Expense Tracking & Profitability Reports",
        "Designed specifically for local shop owners",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Searchable Digital Catalog Showcase",
        "Clear Pricing & Item Details Display",
        "Direct 1-Tap WhatsApp Shopping Checkout",
      ],
