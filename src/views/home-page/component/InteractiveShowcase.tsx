  ...
  const services = [
    {
      ...
      description: t.service_block_card_lead || "A modern, mobile-friendly digital business card page featuring your contact details, owner profiles, products/services gallery, bio, location, and social links in one quick shareable link.",
