...
export const BusinessPageApi = {
  ...
  submitEnquiry: (slug: string, body: { name: string; phone: string; message?: string; isProduct?: boolean; productName?: string; productPrice?: string; productDescription?: string }) =>
